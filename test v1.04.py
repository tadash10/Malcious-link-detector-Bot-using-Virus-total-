...
def check_url_with_virustotal(url):
    """
    Check the given URL with VirusTotal API.
    """
...
def format_response(result):
    """
    Format the response from VirusTotal into a readable message.
    """
...
def send_whatsapp_message(user_id, message):
    """
    Send a message to the user's WhatsApp.
    """
...
def webhook():
    """
    Webhook to receive messages, validate URL, and send VirusTotal results.
    """
